 ...
 * In this custom class, the target view needs only to be displayed with a percentage greater than
 * zero.
 */
public final class ClickWithPartialDisplayConstraint implements ViewAction {
    ...
    @Deprecated
    public ClickWithPartialDisplayConstraint(
            Tapper tapper,
