...
public class Fixture {
  ...
  public void setup() {
   ...
   account2 = new Account(
    ...
    Budget budget = new Budget(0L, account1.getId(), "TITLE", "DESCRIPTION", defaultCurrency, new Money(defaultCurrency, 200000L), Grouping.MONTH, -1, (LocalDate) null, (LocalDate) null);
