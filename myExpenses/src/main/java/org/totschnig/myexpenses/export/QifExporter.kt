...
class QifExporter(account: Account, filter: WhereFilter?, notYetExportedP: Boolean, dateFormat: String,
    ...
    override fun line(id: String, isSplit: Boolean, dateStr: String, payee: String, amount: BigDecimal, labelMain: String, labelSub: String, fullLabel: String, comment: String, methodLabel: String?, status: CrStatus, referenceNumber: String, pictureFileName: String, tagList: String): String = StringBuilderWrapper().apply {
        append("D")
                .append(dateStr)
                .append("\nT")
