...
class AccountRemoteViewsFactory(
    ...
    companion object {
        ...
        private fun RemoteViews.configureButton(context: Context, buttonId: Int, drawableResId: Int, action: String, contentDescriptionResId: Int, account: Account, availableWidth: Int, minimumWidth: Int, clickInfo: Pair<Int, Intent>?) {
         ...
         */
        fun populate(context: Context, remoteViews: RemoteViews, cursor: Cursor, sumColumn: String, availableWidth: Int, clickInfo: Pair<Int, Intent>?) {
            with(remoteViews) {
                ...
                configureButton(context, R.id.command3, R.drawable.ic_menu_split, CLICK_ACTION_NEW_SPLIT, R.string.menu_create_split, account, availableWidth, 271, clickInfo)
            }
        }
