...
class WidgetObserver(private val context: Context, private val mProvider: Class<out AbstractListWidget>) : ContentObserver(null) {
    ...
    companion object {
        ...
        private fun register(context: Context, mProvider: Class<out AbstractListWidget>, observedUris: Array<Uri>) {
