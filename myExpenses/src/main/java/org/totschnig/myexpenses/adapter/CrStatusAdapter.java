...
public class CrStatusAdapter extends ArrayAdapter<Transaction.CrStatus> {
  ...
  public static final int TEXT_VIEW_RESOURCE_ID = android.R.id.text1;
  ...
  private void setText(int position, View row) {
    ((TextView) row.findViewById(TEXT_VIEW_RESOURCE_ID)).setText(getItem(position).toString(getContext()));
  }
