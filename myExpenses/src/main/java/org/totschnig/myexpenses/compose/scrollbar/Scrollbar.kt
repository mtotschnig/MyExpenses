...
/**
 * Sticky headers need to be added with this content type in order to be recognized during
 * calculation of scrollbar state
 */
const val STICKY_HEADER_CONTENT_TYPE = 1
