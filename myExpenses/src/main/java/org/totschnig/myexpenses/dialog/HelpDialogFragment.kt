...
class HelpDialogFragment : DialogViewBinding<HelpDialogBinding>() {
    ...
    companion object {
        ...
        private val iconMap: Map<String, Int?> = mapOf(
            ...
            "hidden_accounts" to com.google.android.material.R.drawable.design_ic_visibility_off,
            "hide" to com.google.android.material.R.drawable.design_ic_visibility_off,
