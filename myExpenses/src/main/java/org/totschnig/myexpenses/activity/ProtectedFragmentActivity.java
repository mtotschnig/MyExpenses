...
public abstract class ProtectedFragmentActivity extends AppCompatActivity
  ...
  protected final boolean shouldUpRecreateTask(Activity from) {
    return from.getIntent().getBooleanExtra(AbstractWidget2Kt.EXTRA_START_FROM_WIDGET, false);
  }
  ...
  protected void forwardDataEntryFromWidget(Intent intent) {
    intent.putExtra(AbstractWidget2Kt.EXTRA_START_FROM_WIDGET_DATA_ENTRY,
        getIntent().getBooleanExtra(AbstractWidget2Kt.EXTRA_START_FROM_WIDGET_DATA_ENTRY, false));
  }
