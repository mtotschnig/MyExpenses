...
val INSERT_TRIGGER_ACTION =
    """INSERT INTO $TABLE_CHANGES($KEY_TYPE,$KEY_SYNC_SEQUENCE_LOCAL, $KEY_UUID, $KEY_PARENT_UUID, $KEY_COMMENT, $KEY_DATE, $KEY_VALUE_DATE, $KEY_AMOUNT, $KEY_ORIGINAL_AMOUNT, $KEY_ORIGINAL_CURRENCY, $KEY_EQUIVALENT_AMOUNT, $KEY_CATID, $KEY_ACCOUNTID,$KEY_PAYEEID, $KEY_TRANSFER_ACCOUNT, $KEY_METHODID,$KEY_CR_STATUS, $KEY_REFERENCE_NUMBER)
        VALUES ('${TransactionChange.Type.created}',
        ${sequenceNumberSelect("new")},
        new.$KEY_UUID,
        ${parentUuidExpression("new")},
        new.$KEY_COMMENT, new.$KEY_DATE, new.$KEY_VALUE_DATE, new.$KEY_AMOUNT, new.$KEY_ORIGINAL_AMOUNT, new.$KEY_ORIGINAL_CURRENCY, new.$KEY_EQUIVALENT_AMOUNT, new.$KEY_CATID, new.$KEY_ACCOUNTID, new.$KEY_PAYEEID, new.$KEY_TRANSFER_ACCOUNT, new.$KEY_METHODID, new.$KEY_CR_STATUS, new.$KEY_REFERENCE_NUMBER);"""
