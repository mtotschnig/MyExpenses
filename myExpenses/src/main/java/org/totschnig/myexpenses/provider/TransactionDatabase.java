...
public class TransactionDatabase extends SQLiteOpenHelper {
  ...
  public void onCreate(SQLiteDatabase db) {
    ...
    ContentValues emptyCatValues = new ContentValues();
    emptyCatValues.put(KEY_ROWID, EMPTY_CATID);
    emptyCatValues.putNull(KEY_PARENTID);
    emptyCatValues.put(KEY_LABEL, Category.NO_CATEGORY_ASSIGNED_LABEL);
    db.insertOrThrow(TABLE_CATEGORIES, null, emptyCatValues);
    insertCurrencies(db);
