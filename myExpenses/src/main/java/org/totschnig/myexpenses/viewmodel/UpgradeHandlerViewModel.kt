    ...
    fun upgrade(fromVersion: Int, @Suppress("UNUSED_PARAMETER") toVersion: Int) {
            viewModelScope.launch(context = coroutineContext()) {
                ...
                if (fromVersion < 557) {
                    ...
                    upgradeInfoList.add(getString(R.string.upgrade_info_557,
                    getString(R.string.pref_category_title_ui), BaseSettingsFragment.legacyItemRendererTitle(localizedContext)))
                }
