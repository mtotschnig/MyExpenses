 ...
 */
//https://github.com/dschuermann/android-calendar-compatibility/blob/master/src/android/provider/CalendarContract.java
...
//        }
    ...
    protected interface EventsColumns {
         ...
         * {@link CalendarContractCompat#ACTION_HANDLE_CUSTOM_EVENT} for details.
         * Column name.
         * <P> Type: TEXT </P>
         */
...
//        }
    ...
    public static final class Reminders implements BaseColumns, RemindersColumns, EventsColumns {
        private static final String REMINDERS_WHERE = CalendarContractCompat.Reminders.EVENT_ID + "=?";
        @SuppressWarnings("hiding")
    ...
    public static final class CalendarAlerts implements BaseColumns,
        ...
        public static void scheduleAlarm(Context context, AlarmManager manager, long alarmTime) {
            ...
            intent.setData(ContentUris.withAppendedId(CalendarContractCompat.CONTENT_URI, alarmTime));
   ...
   public static final class ExtendedProperties implements BaseColumns,
    ...
    public static final class SyncState implements SyncStateContract.Columns {
         ...
         */
        public static final Uri CONTENT_URI =
                Uri.withAppendedPath(CalendarContractCompat.CONTENT_URI, CONTENT_DIRECTORY);
    }
